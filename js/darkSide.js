...
const bgColorsLigth = () => {
  ...
  document
    ...
    .classList.remove("bg-dark-input-and-tasks");
...
const remmemberDarkSide = () => {
  ...
  if (localStorage.getItem("remmemberDarkSide") === null) {
    localStorage.setItem(
      "remmemberDarkSide",
      JSON.stringify(remmemberDarkSide)
    );
  }
  ...
  btn.addEventListener("click", () => {
    const remmemberDarkSide = JSON.parse(
      localStorage.getItem("remmemberDarkSide")
    );
    remmemberDarkSide.darkSide = !remmemberDarkSide.darkSide;
    localStorage.setItem(
      "remmemberDarkSide",
      JSON.stringify(remmemberDarkSide)
    );
